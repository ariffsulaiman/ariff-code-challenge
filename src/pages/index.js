...
export default function Home() {
  ...
  return (
    <div className='flex flex-col my-20'>
      ...
      <section className="flex flex-col md:flex-row md:justify-center md:items-center md:-space-x-8 mx-auto">
        <Image
        ...
        <div className="bg-red-500 w-[90vw] md:w-[43vw] mx-auto md:mx-0 py-4 px-4 md:pt-12 md:pr-6 mt-6 md:mt-0 rounded-md md:rounded-none">
